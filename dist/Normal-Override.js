...
// Upstream version: v6.0.13-normal.9
// Upstream SHA-256: 5cd42bdd40bec0fd30594d264110ac1275e11164693dd15cc5107b8d3c3c29de
...
// 版本：v6.0.13-normal.9 (2026-09-21)
...
// v6.0.13-normal.9：兼容 #183：识别 Clash Party v2.0.3+ 原始订阅 DNS 保护边界，明确客户端内置 DNS 开关与本脚本 DNS 所有权
...
const VERSION = 'v6.0.13-normal.9'
...
function overwriteGeneral(config, nodeDnsHints) {
  ...
  Object.keys(dnsH).forEach(function(k){config.hosts[k]=dnsH[k].slice()})
